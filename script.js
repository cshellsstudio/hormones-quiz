...
const CONFIG = {
  ...
  calendarUrl: 'https://hormones.rcreshil.online/booking',
...
function initResults() {
  ...
  // Build CTA URL
  // Set calendar URL — clean, no quiz params in the visible URL
  const ctaBtn = document.getElementById('ctaBtn');
  ctaBtn.href = CONFIG.calendarUrl;
  ctaBtn.addEventListener('click', function(e) {
    e.preventDefault();
    window.top.location.href = CONFIG.calendarUrl;
  });
...
window.addEventListener('load', () => {
  ...
  if (document.getElementById('results')) {
    initResults();
    // Fix scroll inside iframe — override any height constraints
